package prog.unidad05.gestionficheros.ejercicio04;
...
public class GestionFicheros3App {
  ...
  private static final int OPCION_ULTIMA = OPCION_BORRAR_FICHERO;
   ...
   */
  public GestionFicheros3App(Scanner sc) {
    this.sc = sc;
  }
  ...
  public static void main(String[] args) {
    ...
    GestionFicheros3App app = new GestionFicheros3App(new Scanner(System.in));
    app.run();
